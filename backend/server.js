...
// Backend-specific public files remain available only as a fallback
app.use(
    express.static(
        path.join(__dirname, "public")
    )
...
const customerEventRoutes = require("./routes/customerEventRoutes");
const customerPaymentsRoutes = require("./routes/customerPaymentsRoutes");
...
const purchasingDashboardRoutes = require("./routes/purchasingDashboardRoutes");
...
const notificationQueueWorker = require("./jobs/notificationQueueWorker");
...
app.use("/api/admin/notification-center", notificationCenterRoutes);
app.use("/api/reports", reportRoutes);
app.use("/api/admin/shipments", shipmentRoutes);
app.use("/api/admin/payments", adminPaymentRoutes);
app.use("/api/grn", goodsReceiptRoutes);
app.use("/api/supplier-payments", supplierPaymentRoutes);
app.use("/api/supplier-debit-notes", supplierDebitNoteRoutes);
app.use("/api/purchasing-dashboard", purchasingDashboardRoutes);
